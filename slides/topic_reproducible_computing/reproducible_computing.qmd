...
There is a [new course website](https://bios731.github.io/) where all materials (other than HW) will be shared.
...
Hosted on my GitHub, heavily adapted from [Jeff Goldsmith](https://github.com/jeff-goldsmith/projectr)
...
- **data_dir**: where you want the data to live, if not within your project folder
