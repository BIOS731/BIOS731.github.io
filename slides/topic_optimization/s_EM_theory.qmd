...
- HW3 posted and due 3/4 at 10:00AM
  - Update: Extra credit if you implement SEM or Louis' method
- Where to find lab solutions
...
par(mar = c(5,4, 1, 1))
curve(loglike, 0.01, 0.95, n = 200,xlab = expression(lambda), ylab = "loglik(y)")
```
...
- *Information matrix* from *observed data log-likelihood* would provide inference
...
- $S(y|\theta) = \nabla\log p(y|\theta)$: observed data score function
...
Try doing some inference for the two-part GMM.
