...
\fontsize{10pt}{11pt}\selectfont
Quasi-Newton methods arise from desire to use something like Newton's method without having to compute the Hessian each time.
...
Lab Exercise 3: Begin to implement Newton's method with inference for logistic regression (part 1 of homework).
