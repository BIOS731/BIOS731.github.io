...
lower = as.numeric(my_mod$solution - 1.96 * diag(my_mod$se))
upper = as.numeric(my_mod$solution + 1.96 * diag(my_mod$se))

tibble(beta = as.numeric(my_mod$solution),
       lower = lower, 
       upper = upper)
...
# assume null hypothesis beta = 0

beta_hat = my_mod$solution
info_hat = my_mod$information
